...
public class ClientFactory {
	...
	public Client getConsumerClient() throws NotFoundException, InstantiationException, IllegalAccessException, CannotCompileException{
			String  clientClass = protocolString.substring(0, 1).toUpperCase()+protocolString.substring(1,protocolString.length())+"Client";
